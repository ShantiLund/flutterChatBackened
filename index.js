...
io.sockets.on("connection_failed", function(socket) {

        console.log("socketio chat failed.");
      });
      ...
      //   //function to get user name
        socket.on("set-user-data", function(username) {
          ...
          sendUserStack = function() {
            ...
            io.sockets.emit("onlineStack", userStack);
        ...
        socket.on("set-room", function(room) {
          ...
          setRoom = function(roomId) {
            ...
            io.sockets.to(userSocket[socket.username]).emit("set-room", socket.room);
          };
        ...
        oldChats = function(result, username, room) {
          io.sockets.to(userSocket[username]).emit("old-chats", {
            result: result,
            room: room
          });
        };
